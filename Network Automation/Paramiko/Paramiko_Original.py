...
router = {'hostname': '172.16.215.214', 'port': '22', 'username': 'root', 'password': 'cisco'}
...
myshell.send(b'terminal length 0\n')
myshell.send(b'show version\n')
myshell.send(b'sh ip int br\n')
